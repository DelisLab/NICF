...
%CONSENSUS_CLUSTERING      Consensus clustering modified to work with any 
%                          comm.detection method
%
%   CIU = CONSENSUS_CLUSTERING(D,REPS,TAU) seeks a consensus partition of the 
